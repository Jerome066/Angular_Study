...
@Component({
  ...
  imports: [RouterOutlet, NuevoComponenteComponent, CompInlineComponent, InterpolacionComponent, PadreComponent], //RouterOutlet Permite el cambio de rutas dentro de la palicación
